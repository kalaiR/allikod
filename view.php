        ...
        <section class="banner_area">
            <div class="container">
                <div class="banner_content">
                    <h3 title="View Profile"><img class="left_img" src="img/banner/t-left-img.png" alt=""> View Profile<img class="right_img" src="img/banner/t-right-img.png" alt=""></h3>
        ...
        <section class="blog_grid_area">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="pad">
                            <a href="search_result.php" class="register_angkar_btn login_btn pull-right">Back</a>
                        </div> 
