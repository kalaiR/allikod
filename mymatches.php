        ...
        <section class="banner_area">
            <div class="container">
                <div class="banner_content">
                    <h3 title="My Matches"><img class="left_img" src="img/banner/t-left-img.png" alt="">My Matches<img class="right_img" src="img/banner/t-right-img.png" alt=""></h3>
                  ...
                  <div class="col-md-9">
                      ...
                      <div class="head-box"><h4>Vallikodi ID : V1234567</h4></div>
                        ...
                        <div class="text-box-name">
                          <div class="col-md-6 head-box">
                            <p><a href="view.php">View Full Details</a></p>
                          </div>  
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6">
                    ...
                    <div class="col-md-6 col-sm-6 detail-box">
                      <div class="head-box"><h4>Vallikodi ID : V1234567</h4></div>
                        ...
                        <div class="text-box-name">
                          <div class="col-md-6 head-box">
                            <p><a herf="view.php">View Full Details</a></p>
                          </div>  
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6">
