        ...
        <section class="banner_area">
            <div class="container">
                <div class="banner_content">
                    <h3><img class="left_img" src="img/banner/t-left-img.png" alt="">Payments<img class="right_img" src="img/banner/t-right-img.png" alt=""></h3>
                                ...
                                <div class="row">
                                    <div class="col-sm-4">      
                                        ...
                                        <div class="col-sm-3 aline-center-box image-box">
                                             <img src="img/bank/hdfc.png" alt="bank">
                                        </div>            
                                </div>    
                            </div>               	          
                         </div>
                            <div class="row">
                                ...
                                <div class="col-sm-7 aline-center-box">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3 aline-center-box image-box">
                                            <img src="img/bank/cash.png" alt="bank">
                                        </div>
                                        <div class="col-sm-4 aline-center-box image-box">
                                            <img src="img/bank/cheque.png" alt="bank">
                                        </div>              
                                    </div>
                                </div>   
                                <div class="col-sm-8 aline-center-box">            
