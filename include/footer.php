            ...
            <div class="footer_widgets_area">
                <div class="container">
                    <div class="row">
                        ...
                        <ul id="footer_list">
                            <li id="links_list"><a href="index.php">Home</a></li>
                            <li id="links_list"><a href="registration.php">Registration</a></li>
                            <li id="links_list"><a href="search.php">Search</a></li>
                            <li id="links_list"><a href="gallery.php">Gallery</a></li>
                            <li id="links_list"><a href="success.php">Success Stories</a></li>
                            <li id="links_list"><a href="vanniyar.php">My Vanniyar</a></li>
                            <li id="links_list"><a href="payment.php">Payments</a></li>
                            <li id="links_list"><a href="contact.php">Contact</a></li>
                        </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="copyright">
                <div class="copyright_left">
                    <div class="copyright_text">
                        <h4>© <a href="index.php">Vallikodi</a> 2017  Powered by: <a href="http://etekchnoservices.com/" target="_blank"> ETekchno Services</a> </h4>
                    </div>
                </div>
