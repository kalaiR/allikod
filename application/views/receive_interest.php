        ...
        <section class="banner_area">
            <div class="container">
                <div class="banner_content">
                    <h3 title="Received"><img class="left_img" src="<?php echo media_url(); ?>assets/img/banner/t-left-img.png" alt="">Received Interest<img class="right_img" src="<?php echo media_url(); ?>assets/img/banner/t-right-img.png" alt=""></h3>
                           ...
                           <div class="members_about_box">
                                ...
                                <?php 
                                    ...
                                    <div class="row myview_head">
                                        ...
                                        <div class="col-md-4">Received Date 
                                        </div>
                                    </div>
                                        ...
                                        foreach($results as $key => $value) { 
                                            if($key % 2 == 0){ ?>                                        
                                                <div class="row myview_con">
                                                    <div class="col-md-4">
                                                    <a href="<?php echo base_url()."viewdetail/".$value['sender_profile_id'];?>">
                                                    <?php echo $value['sender_profile_id'];?>
                                                    </a>
                                                    </div>
                                            ...
                                            <?php }else{ ?>
                                                <div class="row myview_nor">
                                                    <div class="col-md-4"><a href="<?php echo base_url()."viewdetail/".$value['sender_profile_id'];?>"><?php echo $value['sender_profile_id'];?></a>
                                                    </div>
                                                    <div class="col-md-4"><?php echo $value['user_fname'];?>
                                                    </div>
                                                    <div class="col-md-4"><?php echo $value['interests_created_date'];?> 
