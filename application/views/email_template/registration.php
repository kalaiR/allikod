...
<table style="width:960px;height:auto;margin:0 auto;border=0;cellpadding=0;cellspacing=0">
        ...
        <tr style="background-color:#74872e;height: 30px;">
            ...
            <td style="width: 200px; display: inline-block;margin-left: 150px; text-align: center; color: #fff;">
                <p1>Vallikodi ID : <?php if(!empty($user_id)) echo "VM".$user_id; ?></p1>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr style="color: #3c6a3c;margin-top: 30px; margin-left: 30px; font-size:25px; font-weight: bold;">
                <td><p style="margin:10 30px;" >Dear <?php if(!empty($user_fname)) echo $user_fname; ?><p></td>
        </tr>
            <tr style="color:black;margin-top:5px; margin-left: 45px; ">
               ...
               <tr>
                    <td>
                        <p style="margin:0 30px; text-align: justify;" >
                        <?php if($reg_purpose == "quick_reg"){ ?>
                            Welcome to Vallikodi Matrimonial!<br><br>Thanks for registering with us.  You have completed your quick registration process. Kindly fill in all the details to find the best matching profiles.<br>Our support team will contact you soon for Verification Process and your profile will be activated once the Verification process is done.
                            <?php }else{ ?>
                            Welcome to Vallikodi Vanniar Matrimonial.Thanks for Registered with us.Our support team will contact you soon for Verification process.We will activate your account once finished our Verification process. (Net Banking payment will be avilable)
                        <?php } ?>
                        </p>
                    </td>
                </tr>      
