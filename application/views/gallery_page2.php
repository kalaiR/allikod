                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="blog_grid_item">
                                <div class="blog_grid_img">
                                    <img src="<?php echo base_url(); ?>assets/img/valli/new_9651Image-(14).jpg" alt="">
                                </div>
                            </div>
                        </div>
                       <div class="col-md-3 col-sm-6">
                            <div class="blog_grid_item">
                                <div class="blog_grid_img">
                                    <img src="<?php echo base_url(); ?>assets/img/valli/new_9399IMG_3835.jpg" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6">
                            <div class="blog_grid_item">
                                <div class="blog_grid_img">
                                    <img src="<?php echo base_url(); ?>assets/img/valli/new_8783IMG_3841.jpg" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6">
                            <div class="blog_grid_item">
                                <div class="blog_grid_img">
                                    <img src="<?php echo base_url(); ?>assets/img/valli/new_8338IMG_3840.jpg" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="blog_grid_item">
                                <div class="blog_grid_img">
                                    <img class="lightbox" src="<?php echo base_url(); ?>assets/img/valli/new_3201IMG_3827.jpg" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6">
                            <div class="blog_grid_item">
                                <div class="blog_grid_img">
                                    <img src="<?php echo base_url(); ?>assets/img/valli/new_2276IMG_3857.jpg" alt="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="blog_grid_item">
                                <div class="blog_grid_img">
                                    <img src="<?php echo base_url(); ?>assets/img/valli/new_1327IMG_3868.jpg" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
