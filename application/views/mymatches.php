        ...
        <section class="banner_area">
            <div class="container">
                <div class="banner_content">
                    <h3 title="My Matches"><img class="left_img" src="<?php echo media_url(); ?>assets/img/banner/t-left-img.png" alt="">My Matches<img class="right_img" src="<?php echo media_url(); ?>assets/img/banner/t-right-img.png" alt=""></h3>
                ...
                <div class="row">
                  <div class="col-md-9">
                    <div class="col-md-4 col-sm-6">
                        <img src="<?php echo media_url(); ?>assets/img/search-result-page/img1.jpg" alt="">
