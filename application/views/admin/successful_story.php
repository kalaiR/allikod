		...
		<div class="row-fluid sortable">		
				<div class="box span12">
					...
					<div class="box-content">
						<a class="btn btn-primary pull-right" id="add" href="<?php echo base_url(); ?>index.php/admin/add_successful_story">
						  ...
						  <tbody>
							...
							<tr>
								...
								<td class="center">
									...
									<a class="btn btn-info" href="<?php echo base_url(); ?>index.php/admin/edit_successful_story/<?php echo $suc_val["successstories_id"] ?>">
