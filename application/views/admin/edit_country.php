	...
	<div id="content" class="span11">
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="<?php echo base_url(); ?>index.php/admin/country">Country</a>
					</li>
				</ul>
			</div>
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal edit_form" method="post" action="country" data-id="<?php echo $this->uri->segment(3); ?>">
<?php } ?>
							<?php
			                  if(!empty($status)) :
							...
							<fieldset>
							  <div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge focused form_inputs" id="focusedInput" type="text" name="cou_name" value="<?php if(!empty($country_data)) echo $country_data['name']; ?>">
								</div>
							  </div>
							  <div class="control-group">
