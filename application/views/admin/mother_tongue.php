				...
				<div class="box span12">
					...
					<div class="box-content">
						<a class="btn btn-primary pull-right" id="add" href="<?php echo base_url(); ?>admin/add_mother_tongue">
						  ...
						  <tbody>
						  <?php
			                      if(!empty($mothertongue_values)) :
			                      $i=0;
			                      foreach ($mothertongue_values as $mt_val) :
			                      $i++;
	                      	  ?>
							<tr>
								<td><?php echo $mt_val['name']; ?></td>
								<td class="center">
									<span class="label label-success">
										<?php 
				                          if ($mt_val['active_status'] == 1) 
				                            echo "Activated";
				                          else
				                            echo "Not-Activated";
				                        ?>
								...
								<td class="center">
									<?php 
			                            $created_datetime = explode(' ', $mt_val['added_date']);
