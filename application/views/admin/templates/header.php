			...
			<ul class="nav nav-tabs nav-stacked sidebar-menu main-menu">
				...
				<li class=""><a href="#"><i class="icon-cog"></i> Settings</a>
					<ul class="sidebar-submenu">
						...
						<li><a class="ajax-link" href="<?php echo base_url(); ?>index.php/admin/mother_tongue"><i class="icon-font"></i><span class="hidden-tablet">Mother Tongue</span></a></li>
						<li><a class="ajax-link" href="<?php echo base_url(); ?>index.php/admin/luknam"><i class="icon-folder-open"></i><span class="hidden-tablet">Luknam</span></a></li>
						<li><a class="ajax-link" href="<?php echo base_url(); ?>index.php/admin/country"><i class="icon-globe"></i><span class="hidden-tablet">Country</span></a></li>
						<li><a class="ajax-link" href="<?php echo base_url(); ?>index.php/admin/education"><i class="icon-edit"></i><span class="hidden-tablet">Education</span></a></li>
						<li><a class="ajax-link" href="<?php echo base_url(); ?>index.php/admin/occupation"><i class="icon-briefcase"></i><span class="hidden-tablet">Occupation</span></a></li>
					</ul>
				</li>
				<!-- New Menu List With Dropdown Begins -->
