	...
	<div class="span2 main-menu-span">
		<div class="well nav-collapse sidebar-nav">
			<ul class="nav nav-tabs nav-stacked main-menu">
				...
				<li><a class="ajax-link" href="selling_admin"><i class="icon-list-alt"></i><span class="hidden-tablet"> Selling Administration View</span></a></li>
				<li class="nav-header hidden-tablet">Report</li>
				<li><a class="ajax-link" href="report"><i class="icon-edit"></i><span class="hidden-tablet"> Report</span></a></li>
				<li class="nav-header hidden-tablet">Successful Story</li>
				<li><a class="ajax-link" href="successful_story"><i class="icon-font"></i><span class="hidden-tablet"> Successful Story</span></a></li>
				...
				<li><a class="ajax-link" href="nakshathra"><i class="icon-calendar"></i><span class="hidden-tablet"> Nakshathra</span></a></li>
				<li><a class="ajax-link" href="mother_tongue"><i class="icon-calendar"></i><span class="hidden-tablet"> Mother Tongue</span></a></li>
				<li><a class="ajax-link" href="luknam"><i class="icon-calendar"></i><span class="hidden-tablet"> Luknam</span></a></li>
