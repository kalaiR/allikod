...
?>      <?php 
                ...
                <div class="row">
                    <div class="col-sm-3">
                        <div class="address_item">
                           ...
                           <div class="address_item">
                                <img src="img/branch/Puducherry.jpg" alt="">
                            </div>
                    </div>                    
                    <div class="col-sm-3">
                        <div class="address_item">
                    ...
                    <div class="col-sm-6">
                        <div class="address_item">
                            <h3>Location</h3>                            
        <!--================Map Area =================-->
                                <div id="googleMap3" style="width:600px; height:200px; position: relative; margin:0 0 0 0; background-color: rgb(229, 227, 223);"></div> 
                        </div>
                    </div>
            </div>
            <div class="padding">
            <div class="row">
                    <div class="col-sm-3">
                        <div class="address_item">
                           ...
                           <div class="address_item">
                                <img src="img/branch/Viruthachalam.jpg" alt="">
                            </div>
                    </div>                    
                    <div class="col-sm-3">
                        <div class="address_item">
                    ...
                    <div class="col-sm-6">
                        <div class="address_item">
                            <h3>Location</h3>       
                            <div id="googleMap4" style="width:600px; height:200px; position: relative; margin:0 0 0 0; background-color: rgb(229, 227, 223);"></div>                 
        <!--================Map Area =================
                                <div id="mapBox" class="mapBox row m0" 
                                    data-lat="11.93084461011536" 
                                    data-lon="11.93084461011536" 
                                    data-zoom="17" 
    ...
    <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d7098.94326104394!2d78.0430654485247!3d27.172909818538997!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2s!4v1385710909804" width="600" height="200" frameborder="0" style="border:0"></iframe>
</div>-->
                        </div>
                    </div>
            </div>
            <div class="row">
                    <div class="col-sm-3">
                        <div class="address_item">
                           ...
                           <div class="address_item">
                                <img src="img/branch/Thirukovilur.jpg" alt="">
                            </div>
                    </div>                    
                    <div class="col-sm-3">
                        <div class="address_item">
                    ...
                    <div class="col-sm-6">
                        <div class="address_item">
                            <h3>Location</h3>                            
        <!--================Map Area =================-->
                                <div id="googleMap5" style="width:600px; height:200px; position: relative; margin:0 0 0 0; background-color: rgb(229, 227, 223);"></div> 
                        </div>
                    </div>
            </div>
            <div class="row">
                    <div class="col-sm-3">
                        <div class="address_item">
                           ...
                           <div class="address_item">
                                <img src="img/branch/Gingee.jpg" alt="">
                            </div>
                    </div>                    
                    <div class="col-sm-3">
                        <div class="address_item">
                    ...
                    <div class="col-sm-6">
                        <div class="address_item">
                            <h3>Location</h3>                            
        <!--================Map Area =================-->
                                <div id="googleMap6" style="width:600px; height:200px; position: relative; margin:0 0 0 0; background-color: rgb(229, 227, 223);"></div> 
                        </div>
                    </div>
            </div>
            <div class="row">
                    <div class="col-sm-3">
                        <div class="address_item">
                           ...
                           <div class="address_item">
                                <img src="img/branch/Chidambaram.jpg" alt="">
                            </div>
                    </div>                    
                    <div class="col-sm-3">
                        <div class="address_item">
            ...
            <div class="row">
                    <div class="col-sm-3">
                        <div class="address_item">
                           ...
                           <div class="address_item">
                                <img src="img/branch/Chengalpatu.jpg" alt="">
                            </div>
                    </div>                    
                    <div class="col-sm-3">
                        <div class="address_item">
            ...
            <div class="row">
                    <div class="col-sm-3">
                        <div class="address_item">
                           ...
                           <div class="address_item">
                                <img src="img/branch/Thiruvannamalai.jpg" alt="">
                            </div>
                    </div>                    
                    <div class="col-sm-3">
                        <div class="address_item">
            ...
            <div class="row">
                    <div class="col-sm-3">
                        <div class="address_item">
                           ...
                           <div class="address_item">
                                <img src="img/branch/ulundurpet.jpg" alt="">
                            </div>
                    </div>                    
                    <div class="col-sm-3">
                        <div class="address_item">
            ...
            <div class="row">
                    <div class="col-sm-3">
                        <div class="address_item">
                           ...
                           <div class="address_item">
                                <img src="img/branch/Tindivanam.jpg" alt="">
                            </div>
                    </div>                    
                    <div class="col-sm-3">
                        <div class="address_item">
            ...
            <div class="row">
                    <div class="col-sm-3">
                        <div class="address_item">
                           ...
                           <div class="address_item">
                                <img src="img/branch/Villupuram.jpg" alt="">
                            </div>
                    </div>                    
                    <div class="col-sm-3">
                        <div class="address_item">
            ...
            <div class="row">
                    <div class="col-sm-3">
                        <div class="address_item">
                           ...
                           <div class="address_item">
                                <img src="img/branch/Cuddalore.jpg" alt="">
                            </div>
                    </div>                    
                    <div class="col-sm-3">
                        <div class="address_item">
            ...
            <div class="row">
                    <div class="col-sm-3">
                        <div class="address_item">
                           ...
                           <div class="address_item">
                                <img src="img/branch/Pandruti.jpg" alt="">
                            </div>
                    </div>                    
                    <div class="col-sm-3">
                        <div class="address_item">
             ...
             <div class="row">
                    <div class="col-sm-3">
                        <div class="address_item">
                           ...
                           <div class="address_item">
                                <img src="img/branch/Kanchipuram.jpg" alt="">
                            </div>
                    </div>                    
                    <div class="col-sm-3">
                        <div class="address_item">
                    ...
                    <div class="col-sm-6">
                        <div class="address_item">
                            <h3>Location</h3>                            
        <!--================Map Area =================-->
                                <div id="googleMap" style="width:600px; height:200px; position: relative; margin:0 0 0 0; background-color: rgb(229, 227, 223);"></div> 
                        </div>
                    </div>
            </div>
            <div class="row">
                    <div class="col-sm-3">
                        <div class="address_item">
                           ...
                           <div class="address_item">
                                <img src="img/branch/Madhuranthagam.jpg" alt="">
                            </div>
                    </div>                    
                    <div class="col-sm-3">
                        <div class="address_item">
            ...
            <div class="row">
                    <div class="col-sm-3">
                        <div class="address_item">
                           ...
                           <div class="address_item">
                                <img src="img/branch/Vandavasi.jpg" alt="">
                            </div>
                    </div>                    
                    <div class="col-sm-3">
                        <div class="address_item">
            ...
            <div class="row">
                    <div class="col-sm-3">
                        <div class="address_item">
                           ...
                           <div class="address_item">
                                <img src="img/branch/vadalur.jpg" alt="">
                            </div>
                    </div>                    
                    <div class="col-sm-3">
                        <div class="address_item">
            ...
            <div class="row">
                    <div class="col-sm-3">
                        <div class="address_item">
                           ...
                           <div class="address_item">
                                <img src="img/branch/Madhagadipet.jpg" alt="">
                            </div>
                    </div>                    
                    <div class="col-sm-3">
                        <div class="address_item">
            ...
            <div class="row">
                    <div class="col-sm-3">
                        <div class="address_item">
                           ...
                           <div class="address_item">
                                <img src="img/branch/Thavalakuppam.jpg" alt="">
                            </div>
                    </div>                    
                    <div class="col-sm-3">
                        <div class="address_item">
            ...
            <div class="row">
                    <div class="col-sm-3">
                        <div class="address_item">
                           ...
                           <div class="address_item">
                                <img src="img/branch/Chethpet.jpg" alt="">
                            </div>
                    </div>                    
                    <div class="col-sm-3">
                        <div class="address_item">
            ...
            <div class="row">
                    <div class="col-sm-3">
                        <div class="address_item">
                           ...
                           <div class="address_item">
                                <img src="img/branch/Uthiramerur.jpg" alt="">
                            </div>
                    </div>                    
                    <div class="col-sm-3">
                        <div class="address_item">
            ...
            <div class="row">
                    <div class="col-sm-3">
                        <div class="address_item">
                           ...
                           <div class="address_item">
                                <img src="img/branch/Kalakurichi.jpg" alt="">
                            </div>
                    </div>                    
                    <div class="col-sm-3">
                        <div class="address_item">
            ...
            <div class="row">
                    <div class="col-sm-3">
                        <div class="address_item">
                           ...
                           <div class="address_item">
                                <img src="img/branch/Thiruporur.jpg" alt="">
                            </div>
                    </div>                    
                    <div class="col-sm-3">
                        <div class="address_item">
            ...
            <div class="row">
                    <div class="col-sm-3">
                        <div class="address_item">
                           ...
                           <div class="address_item">
                                <img src="img/branch/Kalpakkam.jpg" alt="">
                            </div>
                    </div>                    
                    <div class="col-sm-3">
                        <div class="address_item">
...
function initialize() {
  var mapOptions = {
    zoom: 14,
    center: {lat: 11.514364, lng: 79.328324}
  };
  ...
  var marker = new google.maps.Marker({
    ...
    position: {lat: 11.514364, lng: 79.328324},
    map: map
  });
...
function initialize() {
  var mapOptions = {
    zoom: 14,
    center: {lat: 11.969022, lng: 79.203835}
  };
  ...
  var marker = new google.maps.Marker({
    ...
    position: {lat: 11.969022, lng: 79.203835},
    map: map
  });
...
function initialize() {
  var mapOptions = {
    zoom: 14,
    center: {lat: 12.250185578201618, lng: 79.41643238067627}
  };
  map = new google.maps.Map(document.getElementById('googleMap6'),
      mapOptions);

  var marker = new google.maps.Marker({
    
    position: {lat: 12.250185578201618, lng:79.41643238067627},
    map: map
  });
...
function initialize() {
  var mapOptions = {
    zoom: 14,
    center: {lat:11.4435053, lng:79.6388893}
  };
  map = new google.maps.Map(document.getElementById('googleMap7'),
      mapOptions);

  var marker = new google.maps.Marker({
    
    position: {lat:11.4435053, lng:79.6388893},
    map: map
  });
...
function initialize() {
  var mapOptions = {
    zoom: 14,
    center: {lat:12.684052, lng:79.983387}
  };
  map = new google.maps.Map(document.getElementById('googleMap8'),
      mapOptions);

  var marker = new google.maps.Marker({
    
    position: {lat:12.684052, lng:79.983387},
    map: map
  });
...
function initialize() {
  var mapOptions = {
    zoom: 14,
    center: {lat:12.225525, lng:79.074697}
  };
  map = new google.maps.Map(document.getElementById('googleMap9'),
      mapOptions);

  var marker = new google.maps.Marker({
    
    position: {lat:12.225525, lng:79.074697},
    map: map
  });
...
function initialize() {
  var mapOptions = {
    zoom: 14,
    center: {lat:11.690566, lng:79.287429}
  };
  map = new google.maps.Map(document.getElementById('googleMap10'),
      mapOptions);

  var marker = new google.maps.Marker({
    
    position: {lat:11.690566, lng:79.287429},
    map: map
  });
...
function initialize() {
  var mapOptions = {
    zoom: 14,
    center: {lat:12.236884, lng:79.649951} 
  };
  map = new google.maps.Map(document.getElementById('googleMap11'),
      mapOptions);

  var marker = new google.maps.Marker({
    
    position: {lat:12.236884, lng:79.649334},
    map: map
  });
...
function initialize() {
  var mapOptions = {
    zoom: 14,
    center: {lat:11.938906, lng:79.497757}
  };
  map = new google.maps.Map(document.getElementById('googleMap12'),
      mapOptions);

  var marker = new google.maps.Marker({
    
    position: {lat:11.938906, lng:79.497757},
    map: map
  });
...
function initialize() {
  var mapOptions = {
    zoom: 14,
    center: {lat:11.750151, lng:79.750013}
  };
  map = new google.maps.Map(document.getElementById('googleMap13'),
      mapOptions);

  var marker = new google.maps.Marker({
    
    position: {lat:11.750151, lng:79.750013},
    map: map
  });
...
function initialize() {
  var mapOptions = {
    zoom: 14,
    center: {lat:11.775108, lng:79.552603}
  };
  map = new google.maps.Map(document.getElementById('googleMap14'),
      mapOptions);

  var marker = new google.maps.Marker({
    
    position: {lat:11.775108, lng:79.552603},
    map: map
  });
...
function initialize() {
  ...
  map = new google.maps.Map(document.getElementById('googleMap24'),
      mapOptions);
...
function initialize() {
  var mapOptions = {
    zoom: 14,
    center: {lat: 11.922033, lng:  79.631437}
  };
  ...
  var marker = new google.maps.Marker({
    ...
    position: {lat: 11.922033, lng:  79.631437},
    map: map
  });
...
function initialize() {
  var mapOptions = {
    zoom: 14,
    center: {lat: 11.8628791, lng:  79.791619}
  };
  map = new google.maps.Map(document.getElementById('googleMap35'),
      mapOptions);

  var marker = new google.maps.Marker({
    
    position: {lat: 11.8628791, lng:  79.353023},
    map: map
  });
...
function initialize() {
  var mapOptions = {
    zoom: 14,
    center: {lat: 12.4719143, lng:  79.353023}
  };
  map = new google.maps.Map(document.getElementById('googleMap19'),
      mapOptions);

  var marker = new google.maps.Marker({
    
    position: {lat: 12.4719143, lng:  79.353023},
    map: map
  });
...
function initialize() {
  var mapOptions = {
    zoom: 14,
    center: {lat: 12.6172097, lng:  79.7186995}
  };
  map = new google.maps.Map(document.getElementById('googleMap20'),
      mapOptions);

  var marker = new google.maps.Marker({
    
    position: {lat: 12.6172097, lng:  79.7186995},
    map: map
  });
...
function initialize() {
  var mapOptions = {
    zoom: 14,
    center: {lat: 11.7355587, lng:  78.9623624}
  };
  map = new google.maps.Map(document.getElementById('googleMap21'),
      mapOptions);

  var marker = new google.maps.Marker({
    
    position: {lat: 11.7355587, lng:  78.9623624},
    map: map
  });
...
function initialize() {
  var mapOptions = {
    zoom: 14,
    center: {lat: 12.7291974, lng:  80.1804862}
  };
  map = new google.maps.Map(document.getElementById('googleMap22'),
      mapOptions);

  var marker = new google.maps.Marker({
    
    position: {lat: 12.7291974, lng:  80.1804862},
    map: map
  });
...
function initialize() {
  var mapOptions = {
    zoom: 14,
    center: {lat: 11.9392151, lng:  79.8115128}
  };
  map = new google.maps.Map(document.getElementById('googleMap23'),
      mapOptions);

  var marker = new google.maps.Marker({
    
    position: {lat: 11.9392151, lng:  79.8115128},
    map: map
  });
