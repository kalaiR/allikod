...
--
-- Host: localhost
-- Generation Time: Jul 19, 2017 at 07:08 AM
...
INSERT INTO `admin_user` (`adminuser_id`, `adminuser_name`, `adminuser_pwd`, `adminuser_regdate`, `active_status`, `online_statues`, `delete_status`) VALUES
(1, 'admin', 'admin', '2017-07-18 23:12:54', 1, 1, 0);
...
CREATE TABLE IF NOT EXISTS `marital_category` (
  `maritalcategory_id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `reg_payment` (
  `regpayment_id` int(11) NOT NULL AUTO_INCREMENT,
  `reg_user_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `reg_religion_ethnicity` (
  ...
  KEY `rel_mothertongue_id` (`rel_mothertongue_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `renew_detail` (
  `renewdetail_id` int(11) NOT NULL AUTO_INCREMENT,
  `reg_user_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `user_images` (
  `userimages_id` int(11) NOT NULL AUTO_INCREMENT,
  `reg_user_id` int(11) NOT NULL,
...
ALTER TABLE `reg_education_occupation`
  ...
  ADD CONSTRAINT `reg_education_occupation_ibfk_3` FOREIGN KEY (`edu_education`) REFERENCES `education` (`education_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
ALTER TABLE `reg_payment`
  ADD CONSTRAINT `reg_payment_ibfk_1` FOREIGN KEY (`reg_user_id`) REFERENCES `reg_userdetail` (`userdetail_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `reg_religion_ethnicity`
  ADD CONSTRAINT `reg_religion_ethnicity_ibfk_5` FOREIGN KEY (`rel_mothertongue_id`) REFERENCES `mother_tongue` (`mothertongue_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
ALTER TABLE `reg_userdetail`
  ADD CONSTRAINT `reg_userdetail_ibfk_1` FOREIGN KEY (`user_registeredby`) REFERENCES `registered_by` (`registeredby_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `reg_userdetail_ibfk_2` FOREIGN KEY (`user_maritalstatus`) REFERENCES `marital_category` (`maritalcategory_id`) ON DELETE CASCADE ON UPDATE CASCADE;
